with(obj_achievement_manager){
	...
	if(global.gamemode=="normal"){
		if(global.score>=500 and progress[0]==0)
			...
			GetAchievement(17);
		else if(global.score>=10000 and progress[20]==0)
			GetAchievement(20);
		else if(global.survivedTime>=54000 and progress[21]==0)
			GetAchievement(21);
		else if(global.survivedTime>=18000 and obj_player.nomiss==true and progress[22]==0)
			GetAchievement(22);
	} else if(global.gamemode=="hard"){
		if(global.score>=500 and progress[1]==0)
			GetAchievement(1);
		else if(global.survivedTime>=10800 and progress[6]==0)
			GetAchievement(6);
		else if(global.score>=1000 and progress[12]==0)
			GetAchievement(12);
		else if(global.score>=2000 and progress[13]==0)
			GetAchievement(13);
		else if(global.survivedTime>=21600 and progress[18]==0)
			GetAchievement(18);
		else if(global.score>=10000 and progress[20]==0)
			GetAchievement(20);
		else if(global.survivedTime>=54000 and progress[21]==0)
		...
		if(global.survivedTime>=1800 and progress[2]==0)
			...
			GetAchievement(15);
		else if(global.score>=2000 and progress[23]==0)
			GetAchievement(23);
		...
		if(global.survivedTime>=1800 and progress[3]==0)
			...
			GetAchievement(16);
		else if(global.score>=3000 and progress[24]==0)
			GetAchievement(24);
	}
